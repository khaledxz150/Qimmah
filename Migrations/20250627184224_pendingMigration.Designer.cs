...
namespace Qimmah.Migrations
{
    ...
    [Migration("20250627184224_pendingMigration")]
            ...
            modelBuilder.Entity("Qimmah.Data.Activities.ProgramRating", b =>
                {
                    ...
                    b.ToTable("ProgramRatings", "Activities");
                });
            ...
            modelBuilder.Entity("Qimmah.Data.Activities.Sessions", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 4L,
                            EndDateTime = new DateTime(2025, 7, 4, 12, 0, 0, 0, DateTimeKind.Local),
                            IsActive = false,
                            IsCurrentlyBroadcasting = false,
                            IsDeleted = false,
                            LiveBroadcastLink = "https://www.youtube.com/watch?v=example4",
                            ProgramId = 1L,
                            StartDateTime = new DateTime(2025, 7, 4, 10, 0, 0, 0, DateTimeKind.Local)
                        },
                        new
                        {
                            ID = 5L,
                            EndDateTime = new DateTime(2025, 7, 6, 12, 0, 0, 0, DateTimeKind.Local),
                            IsActive = false,
                            IsCurrentlyBroadcasting = false,
                            IsDeleted = false,
                            LiveBroadcastLink = "https://www.youtube.com/watch?v=example5",
                            ProgramId = 1L,
                            StartDateTime = new DateTime(2025, 7, 6, 10, 0, 0, 0, DateTimeKind.Local)
                        });
                });
            ...
            modelBuilder.Entity("Qimmah.Data.Localization.DictionaryLocalization", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ID = 192,
                            LanguageID = 1,
                            Description = "Innovation and Technology Summit 2025"
                        },
                        new
                        {
                            ID = 192,
                            LanguageID = 2,
                            Description = "قمة الابتكار والتكنولوجيا 2025"
                        },
                        new
                        {
                            ID = 193,
            ...
            modelBuilder.Entity("Qimmah.Data.Activities.ProgramRating", b =>
                {
                    ...
                    b.HasOne("Qimmah.Data.User.Users", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
